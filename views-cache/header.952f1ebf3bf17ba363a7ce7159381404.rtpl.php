        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            ...
            <div class="side">
                ...
                <li class="cart-box">
                    <ul class="cart-list">
                        <li>
                            <a href="#" class="photo"><img src="/res/site/images/img-pro-01.jpg" class="cart-thumb" alt="" /></a>
                            <h6><a href="#">Delica omtantur </a></h6>
                            <p>1x - <span class="price">$80.00</span></p>
                        </li>
                        <li>
                            <a href="#" class="photo"><img src="/res/site/images/img-pro-02.jpg" class="cart-thumb" alt="" /></a>
